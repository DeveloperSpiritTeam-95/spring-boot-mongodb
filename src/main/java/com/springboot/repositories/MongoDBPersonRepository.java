...
import com.springboot.dtos.AverageAgeDTO;
import com.springboot.models.PersonEntity;
...
public class MongoDBPersonRepository implements PersonRepository {
    ...
    @PostConstruct
    void init() {
        personCollection = client.getDatabase("SpringMongoDemo").getCollection("PersonEntity", PersonEntity.class);
    }
